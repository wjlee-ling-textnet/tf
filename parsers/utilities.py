...
def get_column_boxes(page, footer_margin=50, header_margin=50, no_image_text=True):
    """Src: https://github.com/pymupdf/PyMuPDF-Utilities/blob/master/text-extraction/multi_column.py
